(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent4 agent1)) (not(CANCALL agent4 agent2)) (CANCALL agent4 agent3) (CANCALL agent4 agent5) (not(CANCALL agent4 agent6)) (CANCALL agent4 agent7) (CANCALL agent4 agent8)
