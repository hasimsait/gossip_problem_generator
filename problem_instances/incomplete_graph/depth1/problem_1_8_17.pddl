(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent4 agent1)) (not(CANCALL agent4 agent2)) (CANCALL agent4 agent3) (CANCALL agent4 agent5) (not(CANCALL agent4 agent6)) (not(CANCALL agent4 agent7)) (CANCALL agent4 agent8)
        ...
        (CANCALL agent8 agent1) (not(CANCALL agent8 agent2)) (not(CANCALL agent8 agent3)) (CANCALL agent8 agent4) (CANCALL agent8 agent5) (CANCALL agent8 agent6) (CANCALL agent8 agent7)
    )
