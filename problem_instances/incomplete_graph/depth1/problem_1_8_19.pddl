(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent5 agent1)) (not(CANCALL agent5 agent2)) (not(CANCALL agent5 agent3)) (CANCALL agent5 agent4) (CANCALL agent5 agent6) (not(CANCALL agent5 agent7)) (CANCALL agent5 agent8)
        ...
        (CANCALL agent8 agent1) (not(CANCALL agent8 agent2)) (not(CANCALL agent8 agent3)) (not(CANCALL agent8 agent4)) (CANCALL agent8 agent5) (CANCALL agent8 agent6) (CANCALL agent8 agent7)
    )
