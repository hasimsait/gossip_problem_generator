(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent1 agent2)) (CANCALL agent1 agent3) (CANCALL agent1 agent4) (CANCALL agent1 agent5) (CANCALL agent1 agent6) (CANCALL agent1 agent7) (CANCALL agent1 agent8)
        ...
        (CANCALL agent3 agent1) (CANCALL agent3 agent2) (CANCALL agent3 agent4) (CANCALL agent3 agent5) (CANCALL agent3 agent6) (CANCALL agent3 agent7) (CANCALL agent3 agent8)
