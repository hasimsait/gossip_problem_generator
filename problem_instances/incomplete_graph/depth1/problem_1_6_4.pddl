(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent2 agent1)) (CANCALL agent2 agent3) (not(CANCALL agent2 agent4)) (CANCALL agent2 agent5) (CANCALL agent2 agent6)
        ...
        (not(CANCALL agent5 agent1)) (CANCALL agent5 agent2) (CANCALL agent5 agent3) (CANCALL agent5 agent4) (CANCALL agent5 agent6)
