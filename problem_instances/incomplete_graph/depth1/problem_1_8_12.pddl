(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent3 agent1)) (CANCALL agent3 agent2) (CANCALL agent3 agent4) (not(CANCALL agent3 agent5)) (CANCALL agent3 agent6) (CANCALL agent3 agent7) (CANCALL agent3 agent8)
