(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent1 agent2)) (not(CANCALL agent1 agent3)) (not(CANCALL agent1 agent4)) (not(CANCALL agent1 agent5)) (CANCALL agent1 agent6)
        (not(CANCALL agent2 agent1)) (CANCALL agent2 agent3) (not(CANCALL agent2 agent4)) (not(CANCALL agent2 agent5)) (not(CANCALL agent2 agent6))
        (not(CANCALL agent3 agent1)) (CANCALL agent3 agent2) (CANCALL agent3 agent4) (not(CANCALL agent3 agent5)) (not(CANCALL agent3 agent6))
        (not(CANCALL agent4 agent1)) (not(CANCALL agent4 agent2)) (CANCALL agent4 agent3) (CANCALL agent4 agent5) (not(CANCALL agent4 agent6))
        (not(CANCALL agent5 agent1)) (not(CANCALL agent5 agent2)) (not(CANCALL agent5 agent3)) (CANCALL agent5 agent4) (CANCALL agent5 agent6)
        (CANCALL agent6 agent1) (not(CANCALL agent6 agent2)) (not(CANCALL agent6 agent3)) (not(CANCALL agent6 agent4)) (CANCALL agent6 agent5)
    )
