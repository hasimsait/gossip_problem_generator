(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent3 agent1)) (CANCALL agent3 agent2) (CANCALL agent3 agent4) (CANCALL agent3 agent5) (CANCALL agent3 agent6)
        (CANCALL agent4 agent1) (not(CANCALL agent4 agent2)) (CANCALL agent4 agent3) (CANCALL agent4 agent5) (CANCALL agent4 agent6)
        (not(CANCALL agent5 agent1)) (not(CANCALL agent5 agent2)) (CANCALL agent5 agent3) (CANCALL agent5 agent4) (CANCALL agent5 agent6)
