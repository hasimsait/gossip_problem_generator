(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent3 agent1)) (CANCALL agent3 agent2) (CANCALL agent3 agent4) (not(CANCALL agent3 agent5)) (not(CANCALL agent3 agent6)) (not(CANCALL agent3 agent7)) (not(CANCALL agent3 agent8))
        (not(CANCALL agent4 agent1)) (not(CANCALL agent4 agent2)) (CANCALL agent4 agent3) (CANCALL agent4 agent5) (not(CANCALL agent4 agent6)) (not(CANCALL agent4 agent7)) (not(CANCALL agent4 agent8))
        (not(CANCALL agent5 agent1)) (not(CANCALL agent5 agent2)) (not(CANCALL agent5 agent3)) (CANCALL agent5 agent4) (CANCALL agent5 agent6) (not(CANCALL agent5 agent7)) (not(CANCALL agent5 agent8))
        (not(CANCALL agent6 agent1)) (not(CANCALL agent6 agent2)) (not(CANCALL agent6 agent3)) (not(CANCALL agent6 agent4)) (CANCALL agent6 agent5) (CANCALL agent6 agent7) (not(CANCALL agent6 agent8))
        (not(CANCALL agent7 agent1)) (not(CANCALL agent7 agent2)) (not(CANCALL agent7 agent3)) (not(CANCALL agent7 agent4)) (not(CANCALL agent7 agent5)) (CANCALL agent7 agent6) (CANCALL agent7 agent8)
        (CANCALL agent8 agent1) (not(CANCALL agent8 agent2)) (not(CANCALL agent8 agent3)) (not(CANCALL agent8 agent4)) (not(CANCALL agent8 agent5)) (not(CANCALL agent8 agent6)) (CANCALL agent8 agent7)
    )
