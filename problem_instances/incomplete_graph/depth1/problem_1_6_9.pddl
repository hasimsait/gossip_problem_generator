(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent1 agent2)) (not(CANCALL agent1 agent3)) (CANCALL agent1 agent4) (not(CANCALL agent1 agent5)) (CANCALL agent1 agent6)
        ...
        (CANCALL agent4 agent1) (not(CANCALL agent4 agent2)) (CANCALL agent4 agent3) (CANCALL agent4 agent5) (not(CANCALL agent4 agent6))
