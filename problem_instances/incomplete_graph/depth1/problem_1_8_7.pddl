(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent2 agent1)) (CANCALL agent2 agent3) (not(CANCALL agent2 agent4)) (CANCALL agent2 agent5) (CANCALL agent2 agent6) (CANCALL agent2 agent7) (CANCALL agent2 agent8)
