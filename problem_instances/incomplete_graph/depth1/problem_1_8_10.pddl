(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent2 agent1)) (CANCALL agent2 agent3) (not(CANCALL agent2 agent4)) (not(CANCALL agent2 agent5)) (not(CANCALL agent2 agent6)) (not(CANCALL agent2 agent7)) (CANCALL agent2 agent8)
        ...
        (not(CANCALL agent5 agent1)) (not(CANCALL agent5 agent2)) (CANCALL agent5 agent3) (CANCALL agent5 agent4) (CANCALL agent5 agent6) (CANCALL agent5 agent7) (CANCALL agent5 agent8)
        (not(CANCALL agent6 agent1)) (not(CANCALL agent6 agent2)) (CANCALL agent6 agent3) (CANCALL agent6 agent4) (CANCALL agent6 agent5) (CANCALL agent6 agent7) (CANCALL agent6 agent8)
        (not(CANCALL agent7 agent1)) (not(CANCALL agent7 agent2)) (CANCALL agent7 agent3) (CANCALL agent7 agent4) (CANCALL agent7 agent5) (CANCALL agent7 agent6) (CANCALL agent7 agent8)
