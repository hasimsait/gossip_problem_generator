(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent1 agent2)) (not(CANCALL agent1 agent3)) (not(CANCALL agent1 agent4)) (not(CANCALL agent1 agent5)) (CANCALL agent1 agent6) (CANCALL agent1 agent7) (CANCALL agent1 agent8)
        ...
        (CANCALL agent6 agent1) (CANCALL agent6 agent2) (CANCALL agent6 agent3) (CANCALL agent6 agent4) (CANCALL agent6 agent5) (CANCALL agent6 agent7) (CANCALL agent6 agent8)
