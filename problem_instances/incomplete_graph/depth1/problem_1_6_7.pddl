(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent3 agent1)) (CANCALL agent3 agent2) (CANCALL agent3 agent4) (not(CANCALL agent3 agent5)) (CANCALL agent3 agent6)
        ...
        (CANCALL agent6 agent1) (not(CANCALL agent6 agent2)) (CANCALL agent6 agent3) (CANCALL agent6 agent4) (CANCALL agent6 agent5)
    )
