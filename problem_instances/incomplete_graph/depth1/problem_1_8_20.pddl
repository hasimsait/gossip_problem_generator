(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent6 agent1)) (not(CANCALL agent6 agent2)) (not(CANCALL agent6 agent3)) (not(CANCALL agent6 agent4)) (CANCALL agent6 agent5) (CANCALL agent6 agent7) (CANCALL agent6 agent8)
        ...
        (CANCALL agent8 agent1) (not(CANCALL agent8 agent2)) (not(CANCALL agent8 agent3)) (not(CANCALL agent8 agent4)) (not(CANCALL agent8 agent5)) (CANCALL agent8 agent6) (CANCALL agent8 agent7)
    )
