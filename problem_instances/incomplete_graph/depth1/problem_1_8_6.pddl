(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent7 agent1)) (CANCALL agent7 agent2) (CANCALL agent7 agent3) (CANCALL agent7 agent4) (CANCALL agent7 agent5) (CANCALL agent7 agent6) (CANCALL agent7 agent8)
