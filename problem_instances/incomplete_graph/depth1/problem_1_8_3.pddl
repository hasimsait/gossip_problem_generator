(define (problem problemGossip)
    ...
    (:init
        ...
        (not(CANCALL agent1 agent2)) (not(CANCALL agent1 agent3)) (not(CANCALL agent1 agent4)) (CANCALL agent1 agent5) (CANCALL agent1 agent6) (CANCALL agent1 agent7) (CANCALL agent1 agent8)
        ...
        (CANCALL agent5 agent1) (CANCALL agent5 agent2) (CANCALL agent5 agent3) (CANCALL agent5 agent4) (CANCALL agent5 agent6) (CANCALL agent5 agent7) (CANCALL agent5 agent8)
